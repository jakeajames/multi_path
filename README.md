...
First is via dropbear (aka SSH; requires you to run /var/profile manually to get anything working) and the other via netcat if dropbear for some reason doesn't work or you prefer it?. You can drop any binaries in the iosbinpack64 directory. All binaries must have at least these two entitlements:
