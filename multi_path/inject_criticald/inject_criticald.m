...
int main(int argc, char* argv[]) {
    ...
    [messageCenter sendMessageAndReceiveReplyName:@"platformize" userInfo:[NSDictionary dictionaryWithObject:[NSString stringWithFormat:@"%d", getpid()] forKey:@"pid"]]; //we need to be platform in order to inject on platform binaries
    
    usleep(1000);
    
	uint32_t pid = atoi(argv[1]);
    
    [messageCenter sendMessageAndReceiveReplyName:@"platformize" userInfo:[NSDictionary dictionaryWithObject:[NSString stringWithFormat:@"%d", pid] forKey:@"pid"]]; //target has to be platform if we're platform
    
    [messageCenter sendMessageAndReceiveReplyName:@"setcsflags" userInfo:[NSDictionary dictionaryWithObject:[NSString stringWithFormat:@"%d", pid] forKey:@"pid"]]; //get-task-allow csflag
    
    NSMutableDictionary *dict = [NSMutableDictionary dictionary];
    [dict setValue:@"com.apple.private.skip-library-validation" forKey:@"ent"]; //load unsigned dylibs
    [dict setValue:@"true" forKey:@"value"];
    ...
    [dict setValue:@"get-task-allow" forKey:@"ent"]; //get-task-allow entitlement
    [dict setValue:@"true" forKey:@"value"];
